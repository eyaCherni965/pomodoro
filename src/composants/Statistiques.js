...
// Composant de la page Statistiques hebdomadaires
function Statistiques() {
  // Données des sessions par jour
  const data = [
    { jour: "L", sessions: 3 },
    { jour: "M", sessions: 5 },
    { jour: "Me", sessions: 2 },
  ...
  return (
    <div className="w-screen min-h-screen bg-gradient-to-r from-blue-100 to-violet-300 flex flex-col items-center justify-start pt-10 gap-6">
      ...
      <div className="flex gap-1">
        <span className="text-violet-700 font-bold text-sm sm:text-xl hover:scale-110 transition duration-300">10</span>
        ...
        <span className="text-violet-700 font-bold text-sm sm:text-xl hover:scale-110 transition duration-300">3h40min</span>
      </div>
